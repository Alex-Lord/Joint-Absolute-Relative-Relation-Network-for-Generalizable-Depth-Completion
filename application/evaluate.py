        ...
        for method in method_list:
            for dataset in dataset_list:
                ...
                for mode in mode_list:
                    ...
                    log_path = os.path.join('/data1/Chenbingyuan/Trans_G2/g2_dataset/', dataset, mode, 'logs_ablation_G2_sfv2.txt')
                    # 0-100
        ...
        for method in method_list:
            for dataset in dataset_list:
                ...
                for mode in mode_list:
                    ...
                    log_path = os.path.join('/data1/Chenbingyuan/Trans_G2/g2_dataset/', dataset, mode, 'logs_absrel_G2_sfv2.txt')
...
def delete_txt_file(dataset_list):
    for data_set in dataset_list:
        txt_file_1 = '/data1/Chenbingyuan/Trans_G2/g2_dataset/'+data_set+'/result/'+ 'logs_ablation_G2_sfv2.txt'
        txt_file_2 = '/data1/Chenbingyuan/Trans_G2/g2_dataset/'+data_set+'/result/'+ 'logs_absrel_G2_sfv2.txt'
        # 检查文件是否存在
        # print(txt_file_1)
