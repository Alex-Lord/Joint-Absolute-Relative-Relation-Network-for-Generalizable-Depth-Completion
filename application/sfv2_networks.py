...
class JARRN_nosoftmax(Module):
    def __init__(self, layer_num: int = 7, rezero: bool = True):
        super(JARRN_nosoftmax, self).__init__()
...
class LRRU_retrain(Module):
    def __init__(self,rezero: bool = True):
        ...
        self.arg.add_argument('-c', '--configuration', type=str, default='/data1/Chenbingyuan/Depth-Completion/src/baselines/LRRU/configs/val_lrru_base_kitti.yml')
