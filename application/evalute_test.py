        ...
        for method in method_list:
            for dataset in dataset_list:
                ...
                for mode in mode_list:
                    gt_path = os.path.join('/data1/Chenbingyuan/Depth-Completion/g2_dataset/', dataset, 'val')
                    for pro in pro_dict[mode]:
                        log_path = os.path.join('/data1/Chenbingyuan/Depth-Completion/g2_dataset/', dataset, mode, 'logs', f'logs_{method}_{pro}.txt')
...
if __name__ == '__main__':
    ...
    for dataset in datasets:
        log_dir = os.path.join('/data1/Chenbingyuan/Depth-Completion/g2_dataset/', dataset ,'result','logs')
        check_path(log_dir)
        for file in os.listdir(log_dir):
            if file.startswith('logs_rz') and file.endswith('.txt'):
                delete_file(os.path.join('/data1/Chenbingyuan/Depth-Completion/g2_dataset/', dataset,'result',file))
                print(file)
