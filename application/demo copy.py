        ...
        for method in method_list:
            ...
            for epoch in epoch_list:
                ...
                if method == 'rz_sb_mar_G2_Mono':
                    # G2_Mono
                    from src.baselines.G2_Mono import G2_Mono
                    ...
                    # PEnet
                    from src.baselines.PEnet.model import PENet_C2
                    from src.baselines.PEnet.config import args as args_penet
                    ...
                    network = network.cuda()
                    network.load_state_dict(torch.load(model_dir, map_location='cuda:0')['model'],strict=False)  # PEnet
                    print(f'sys.path after PEnet = {sys.path}')
...
rgbd_dir = ['ETH3D','Ibims', 'KITTI', 'VKITTI', 'Matterport3D', 'UnrealCV']
...
#                'rz_sb_mar_NLSPN_KITTI',  'rz_sb_mar_sfv2_DIODE_HRWSI', 'rz_sb_mar_sfv2_DIODE_HRWSI_no_f',
...
method_list = ['rz_sb_mar_SDCM','rz_sb_mar_GuideNet','rz_sb_mar_ReDC']
method_list = ['rz_sb_mar_GuideNet',]
# method_list = ['rz_sb_mar_sfv2_DIODE_HRWSI', 'rz_sb_mar_sfv2_DIODE_HRWSI_no_f',
#                'rz_sb_mar_sfv2_DIODE_HRWSI_no_p', 'rz_sb_mar_sfv2_DIODE_HRWSI_only_f', 'rz_sb_mar_sfv2_DIODE_HRWSI_only_p',
#                'rz_sb_mar_sfv2_DIODE_HRWSI_only_s']
# 'rz_sb_mar_LRRU' 'rz_sb_mar_PEnet'  'rz_sb_mar_SDCM', 需要切换环境
