        ...
        for method in method_list:
            for dataset in dataset_list:
                ...
                for mode in mode_list:
                    ...
                    log_path = os.path.join('/data1/Chenbingyuan/Depth-Completion/g2_dataset/', dataset, mode, 'logs_ablation_1.txt')
                    # 0-100
                    for pro in pro_dict[mode]:
                        ...
                        if pro == 0.0:
                            ...
                            rmse, rel, imae, mae = self.evaluate_depth_dataset(depth_path, gt_path, pro)
                            with open(log_path, 'a') as log_file:
                                log_file.write(
                                    method + '_' + str(pro) +
                                    ': AbsRel= ' + str(rel) +
        ...
        for method in method_list:
            for dataset in dataset_list:
                ...
                for mode in mode_list:
                    ...
                    log_path = os.path.join('/data1/Chenbingyuan/Depth-Completion/g2_dataset/', dataset, mode, 'logs_absrel_1.txt')
                    ...
                    for pro in pro_dict[mode]:
                        ...
                        if pro != 0.0:
                            ...
                            rmse, imae, mae = self.inverse_evaluate_depth_dataset(depth_path, gt_path, pro)
                            with open(log_path, 'a') as log_file:
                                log_file.write(
                                    method + '_' + str(pro) +
                                    ': RMSE= {:.4f}'.format(rmse) + 
...
def delete_txt_file(dataset_list):
    for data_set in dataset_list:
        txt_file_1 = '/data1/Chenbingyuan/Depth-Completion/g2_dataset/'+data_set+'/result/'+ 'logs_ablation_1.txt'
        txt_file_2 = '/data1/Chenbingyuan/Depth-Completion/g2_dataset/'+data_set+'/result/'+ 'logs_absrel_1.txt'
        # 检查文件是否存在
        # print(txt_file_1)
