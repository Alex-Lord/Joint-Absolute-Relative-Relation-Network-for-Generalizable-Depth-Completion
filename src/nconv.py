...
class NConv2d(_ConvNd):
    def __init__(self, in_channels, out_channels, kernel_size, pos_fn='softplus', init_method='k', stride=(1,1), padding=(0,0), dilation=(1,1), groups=1, bias=True):
        ...
        self.alpha = Parameter(torch.tensor(0.0))  # Rezero 
    ...
    def forward(self, data, conf):
        ...
        nconv = nomin / (denom+self.eps)  + nomin * self.alpha
