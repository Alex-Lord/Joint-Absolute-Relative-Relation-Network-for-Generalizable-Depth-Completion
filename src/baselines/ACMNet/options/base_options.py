...
import os
import sys
sys.path.append('/data/8T/cby/Trans_G2/src/baselines/ACMNet')
import util
import torch
import models
import data
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--knn', nargs='+', type=int, default=[3,3,3], help='number of nearest-neighbour')
        parser.add_argument('--nsamples', nargs='+', type=int, default=[10000, 5000, 2500], help='sampling ratio')
