...
import math
import sys
sys.path.append('/data/8T/cby/Trans_G2/src/baselines/SemAttNet')
from basic import *
...
class A_CSPN_plus_plus(nn.Module):
    ...
    def forward(self, rgb, d, seg):
        ...
        feature_s1, feature_s2, rgb_conf, semantic_conf, d_conf, rgb_depth, semantic_depth, d_depth, coarse_depth = self.backbone(rgb, d, seg)
