...
class MobileNetV2(nn.Module):
    def __init__(self, n_class=1000, input_size=224, width_mult=1.):
        ...
        # transfer features to modulelist
...
def mobilenet_v2(pretrained=True, width_mult=1):
    model = MobileNetV2(width_mult=width_mult)

    if pretrained:
        state_dict = torch.load('/data/4TSSD/cby/Trans_G2/src/baselines/EMDC/models/pretrained/mobilenetv2.pth.tar', map_location='cpu')
