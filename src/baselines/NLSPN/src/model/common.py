...
model_path = {
    'resnet18': '/data1/Chenbingyuan/Depth-Completion/src/baselines/NLSPN/src/pretrained/resnet18.pth',
    'resnet34': '/data1/Chenbingyuan/Depth-Completion/src/baselines/NLSPN/src/pretrained/resnet34.pth'
}
