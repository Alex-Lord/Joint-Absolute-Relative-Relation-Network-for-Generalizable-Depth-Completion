...
model_path = {
    'resnet18': '/data/8T/cby/Trans_G2/src/baselines/NLSPN/src/pretrained/resnet18.pth',
    'resnet34': '/data/8T/cby/Trans_G2/src/baselines/NLSPN/src/pretrained/resnet34.pth'
}
