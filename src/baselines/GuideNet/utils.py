...
import sys
import os
sys.path.append('/data1/Chenbingyuan/Depth-Completion/src/baselines/GuideNet')
import torch
import random
import numpy as np
import augs
...
def resume_state(config, model):
    ...
    cp_path = os.path.join('/data1/Chenbingyuan/Depth-Completion/src/baselines/GuideNet/checkpoints/GNS_1600/result.pth')
